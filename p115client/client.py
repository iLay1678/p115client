...
class ClientRequestMixin:
    ...
    def login_with_qrcode(
        ...
        **request_kwargs, 
        ...
        | 07    | D2       | ?          | 未知: ios            |
        +-------+----------+------------+----------------------+
        | 08    | D3       | 115ios     | 115_苹果端           |
        +-------+----------+------------+----------------------+
        | 09    | F1       | android    | 115生活_安卓端       |
        +-------+----------+------------+----------------------+
        | 10    | F2       | ?          | 未知: android        |
        +-------+----------+------------+----------------------+
        | 11    | F3       | 115android | 115_安卓端           |
        +-------+----------+------------+----------------------+
        | 12    | H1       | ?          | 未知: ipad           |
        +-------+----------+------------+----------------------+
        | 13    | H2       | ?          | 未知: ipad           |
        +-------+----------+------------+----------------------+
        | 14    | H3       | 115ipad    | 115_苹果平板端       |
        +-------+----------+------------+----------------------+
        | 15    | I1       | tv         | 115生活_安卓电视端   |
        +-------+----------+------------+----------------------+
        | 16    | I2       | apple_tv   | 115生活_苹果电视端   |
        +-------+----------+------------+----------------------+
        | 17    | M1       | qandriod   | 115管理_安卓端       |
        +-------+----------+------------+----------------------+
        | 18    | N1       | ?          | 115管理_苹果端       |
        +-------+----------+------------+----------------------+
        | 19    | O1       | ?          | 未知: ipad           |
        +-------+----------+------------+----------------------+
        | 20    | P1       | windows    | 115生活_Windows端    |
        +-------+----------+------------+----------------------+
        | 21    | P2       | mac        | 115生活_macOS端      |
        +-------+----------+------------+----------------------+
        | 22    | P3       | linux      | 115生活_Linux端      |
        +-------+----------+------------+----------------------+
        | 23    | R1       | wechatmini | 115生活_微信小程序端 |
        +-------+----------+------------+----------------------+
        | 24    | R2       | alipaymini | 115生活_支付宝小程序 |
        +-------+----------+------------+----------------------+
        | 25    | S1       | harmony    | 115_鸿蒙端           |
        +-------+----------+------------+----------------------+
        """
        def gen_step():
